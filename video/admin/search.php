	...
	<div class="inner" style="min-height: 500px;">
		...
		<div class="col-md-12">
			<table class="table table-bordered table-striped">
				...
				<?php
					$uname = $_POST['vname'];
					$sql1="select * from (select * from users where uname like '%$uname%') as lik limit $start,$rowsperpage";
					echo $sql;
				...
				<tr>
					<td colspan="9" align="center">
						<?php 
							...
							if ($forward>0) {
							  echo "<a href='search.php?page=$forward'>上一页</a>  ";
							}
							for ($i=1; $i<=$totalpages ;$i++) { 
								echo "  <a href='search.php?page=$i'>第{$i}页</a>  ";
							}
								if ($next<=$totalpages) {
								   echo "  <a href='search.php?page=$next'>下一页</a>  ";
							}
								echo "  <a href='search.php?page=$totalpages'>尾页</a>  ";
						 ?>
					</td>
				</tr>
			</table>
